    ...
    if ($object->xpdo) {
        ...
        switch ($options[xPDOTransport::PACKAGE_ACTION]) {
            ...
            case xPDOTransport::ACTION_UPGRADE:
                $modelPath = $modx->getOption('usersonline_core_path', null,
                        $modx->getOption('core_path') . 'components/usersonline/') . 'model/';
                $modx->addPackage('usersonline', $modelPath);

                $manager = $modx->getManager();
                $objects = array();
                $schemaFile = MODX_CORE_PATH . 'components/usersonline/model/schema/usersonline.mysql.schema.xml';
            ...
            case xPDOTransport::ACTION_UNINSTALL:
                ...
                /*
                $modelPath = $modx->getOption('usersonline_core_path', null, $modx->getOption('core_path') . 'components/usersonline/') . 'model/';
                $modx->addPackage('usersonline', $modelPath);
