<?php
    ...
    $_lang['setting_usersonline_time_span'] = 'Временной промежуток';
    $_lang['setting_usersonline_time_span'] = 'Указывается в секундах, 20 минут = 1200, 15 минут = 900, 10 минут = 600, 5 минут = 300';
